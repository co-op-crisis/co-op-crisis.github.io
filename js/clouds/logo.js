;(function(){
  ...
  svgIcon = '<svg width="22" height="22" id="svg2" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" version="1.1" viewBox="0 0 491.5 476.1"> <defs> <style> .cls-1 { fill: #A19995; fill-rule: evenodd; stroke-width: 0px; } </style> </defs> <sodipodi:namedview id="namedview4" bordercolor="#000000" borderopacity="0.25" inkscape:deskcolor="#d1d1d1" inkscape:pagecheckerboard="0" inkscape:pageopacity="0.0" inkscape:showpageshadow="2" pagecolor="#ffffff"/> <g id="g8" inkscape:groupmode="layer" inkscape:label="ink_ext_XXXXXX"> <g id="g10"> <path id="path12" class="cls-1" d="M79.2,228.6L240.6,73.4c2.9-2.8,7.5-2.8,10.3,0h0s0,0,0,0l159.7,155.1h0s5.2,4.7,5.2,4.7c1.6,1.5,2.5,3.5,2.5,5.5h0v229.7c0,4.1-3.3,7.4-7.4,7.4h-114.4v-139.7c0-4.1-3.3-7.4-7.4-7.4h-86.8c-4.1,0-7.4,3.3-7.4,7.4v139.7h-114.4c-4.1,0-7.4-3.3-7.4-7.4v-231c0-2.3,1-4.4,2.7-5.7l3.4-3.3"/> <path id="path14" class="cls-1" d="M245.8,35.4L25.1,244.9c-5.9,5.6-15.4,5.4-21-.5-5.7-5.9-5.4-15.4.5-21L235.5,4.1c5.7-5.5,14.8-5.4,20.5,0l230.9,219.3c6,5.7,6.2,15.1.5,21-5.7,5.9-15.1,6.2-21,.5L245.8,35.4"/> <path id="path16" class="cls-1" d="M113.7,144.4l-29.3,41.9h-26.2V57.4h74v84.3l-18.5,2.7"/> </g> </g> </svg>';

  document.head.insertAdjacentHTML('beforeend','<style>.shaw { display: block; position: absolute; position: fixed; z-index: 9999; bottom: 5px; right: 5px; font-size: 10px; color: #c03b27; text-decoration: none; padding: 10px; border-radius: 50%; opacity: .75; /*0.4;*/ transform-origin: 100% 100%; transition: all 300ms ease-in-out; background: rgba(255,255,255,0.9); } .shaw > * { transition: inherit; } .shaw:hover { opacity: 1; background: rgba(255,255,255,0.9); } .shaw__icon, .shaw__title { display: inline-block; vertical-align: middle; } .shaw__icon { width: 24px; height: 24px; position: relative; z-index: 1; } .shaw__title {  white-space: nowrap; opacity: 0; padding-right: 10px; transform: translateX(100%); } .shaw:hover .shaw__title { transform: scale(1); opacity: 1; } .shaw:hover .shaw__icon { transform: scale(1.4); } </style>'); // .shaw__title { position: absolute; right: 100%; top: 50%; margin-top: -0.5em;width: fit-content; position: absolute; right: 100%; margin-right: 10px; }
  
  var a = document.createElement('a');
  a.setAttribute('href','javascript:closeOverlays()');
